    ...
    >
      <section className="flex items-center justify-between w-full gap-2">
        <menu className="flex items-start flex-col gap-3 max-[700px]:gap-2">
          <h3 className="text-secondary font-medium text-[15px] max-[1200px]:text-[14px] max-[700px]:text-[13px]">
            {title}
          </h3>
        ...
        <figure className="p-3 rounded-xl flex items-center justify-center bg-primary">
          <FontAwesomeIcon
            className="text-white text-[20px] max-[500px]:text-[16px]"
            icon={icon}
          />
        </figure>
      </section>
...
export default StaffDashboardCard;
