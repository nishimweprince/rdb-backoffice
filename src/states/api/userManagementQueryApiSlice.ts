...
export const userManagementQueryApiSlice = createApi({
  reducerPath: 'userManagementQueryApi',
...
} = userManagementQueryApiSlice;

export default userManagementQueryApiSlice;
