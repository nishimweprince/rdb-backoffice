...
import { validatePassword } from '@/helpers/validations.helper';
...
const NewResetPassword = () => {
  ...
  return (
    <main className="flex flex-col gap-4 w-full mx-auto bg-background">
        ...
        >
          ...
          <menu className="flex flex-col w-full gap-4">
            ...
            <ul className="w-full flex flex-col gap-3 items-center justify-center">
              ...
              >
                {resetPasswordIsLoading ? <Loader /> : `Submit`}
              </Button>
              <Button
                className="!text-[14px]"
                styled={false}
